...
Security is a top priority for Network Mate, especially given the sensitive nature of telecom and location data.
...
## Privacy First
Network Mate operates on a strict Privacy-First principle. Any PR that attempts to bypass the `SecurityManager` consent flow or extract raw PII (Personally Identifiable Information) without encryption will be immediately rejected.
