package com.signalsense.ai.data.repository

import com.signalsense.ai.data.local.SignalDao
import com.signalsense.ai.data.local.SignalReadingEntity
import com.signalsense.ai.data.local.SpeedTestEntity
import com.signalsense.ai.data.remote.SpeedTestEngine
...
class NetworkRepository @Inject constructor(
    ...
    fun runSpeedTest(): Flow<SpeedResultState> = flow {
        ...
        speedTestEngine.runDownloadTest().collect { result ->
            when (result) {
                is com.signalsense.ai.data.remote.SpeedResult.Progress -> {
                    emit(SpeedResultState.Downloading(result.speedMbps))
                }
                is com.signalsense.ai.data.remote.SpeedResult.Completed -> {
                ...
                is com.signalsense.ai.data.remote.SpeedResult.Error -> {
